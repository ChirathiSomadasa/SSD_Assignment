...
import { useAuthEmail, useIsAuthenticated } from '../../auth';
...
function Header() {
    ...
    const isAuthenticated = useIsAuthenticated(); // check login state
    ...
    function onSignOutClick() {
        // clear token + email on logout
        localStorage.removeItem("token");
        document.cookie = "auth_email=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
        navigate("/login");
        window.location.reload(); // force re-render header state
    }
        ...
        <div className="header">
            <div className="header-top">
                ...
                <div className="header-right">
                    ...
                    {/* Show SignOut only if authenticated */}
                    {isAuthenticated && (
                    ...
                    {/* Notification Button - visible only if logged in */}
                    {isAuthenticated && (
                        <div className="notification-wrapper">
                            <HeaderButton 
                                ...
                                badgeActive={hasNewNotifications}
                            >
