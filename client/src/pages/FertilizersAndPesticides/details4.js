...
function Details4() {
  ...
  const productImage = productImages[product.image] || '../../images/fertilizers/cover.jpg';

  return (
    <div className="details-container">
      <div className="details-left">
        <div className='product-image'>
          <img src={productImage} alt={product.name || "Cover"} />
        </div>
