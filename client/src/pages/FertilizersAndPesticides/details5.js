...
function Details5() {
  ...
  const productImage = productImages[product.image] || '../../images/fertilizers/goldpower.png';

  return (
    <div className="details-container">
      <div className="details-left">
        <div className='product-image'>
          <img src={productImage} alt={product.name || "GOLDPOWER"} />
        </div>
